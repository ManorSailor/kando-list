...
const taskBody = createElement(`<article class="flex items-center w-full hover:bg-gray-600/50 transition-colors rounded-lg overflow-hidden animate-[fade-in_250ms_cubic-bezier(0.4,_0,_0.2,_1)]"></article>`);

function TaskView(task, callback) {
    const taskView = taskBody.cloneNode(true);
